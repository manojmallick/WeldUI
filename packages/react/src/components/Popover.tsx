...
export const Popover = forwardRef<HTMLElement, WuPopoverProps>(
  ({ onWuOpen, onWuClose, children, className, style, ...props }, ref) => {
    ...
    return React.createElement('wu-popover', { ref: resolvedRef, class: className, style, ...props }, children);
  }
);
Popover.displayName = 'WuPopover';
