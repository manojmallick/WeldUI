...
export const Collapse = forwardRef<HTMLElement, WuCollapseProps>(
  ({ onWuOpen, onWuClose, className, style, children, ...props }, ref) => {
    ...
    return React.createElement('wu-collapse', { ref: resolvedRef, class: className, style, ...props }, children);
  }
);
Collapse.displayName = 'WuCollapse';
