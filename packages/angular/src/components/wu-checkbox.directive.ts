...
/**
 * Directive wrapper for the <wu-checkbox> Web Component.
 * Implements ControlValueAccessor (boolean value) for Angular forms.
 */
@Directive({
  selector: 'wu-checkbox',
  standalone: true,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => WuCheckboxDirective),
      multi: true,
    },
  ],
})
export class WuCheckboxDirective implements OnInit, OnDestroy, ControlValueAccessor {
