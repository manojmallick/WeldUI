...
/**
 * Directive wrapper for the <wu-input> Web Component.
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => WuInputDirective),
      multi: true,
    },
  ],
})
export class WuInputDirective implements OnInit, OnDestroy, ControlValueAccessor {
