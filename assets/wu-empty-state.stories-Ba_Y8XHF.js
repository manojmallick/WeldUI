import{b as s}from"./lit-element-CWHijwDH.js";import"./index-BM5e8oBU.js";const f={title:"Components/EmptyState",component:"wu-empty-state",tags:["autodocs"],argTypes:{title:{control:"text"},description:{control:"text"}}},t={args:{title:"Nothing here yet",description:"Get started by creating your first item."},render:n=>s`
  ...
  \`
}`,...(h=(g=o.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const x=["Default","WithAction","NoData","CustomIcon"];export{o as CustomIcon,t as Default,r as NoData,e as WithAction,x as __namedExportsOrder,f as default};
