import{b as u}from"./lit-element-CWHijwDH.js";import"./index-BM5e8oBU.js";const v={title:"Components/Avatar",component:"wu-avatar",tags:["autodocs"],argTypes:{size:{control:"radio",options:["sm","md","lg","xl"]}}},a={args:{initials:"MM",size:"md"},render:s=>u`<wu-avatar initials=${s.initials} size=${s.size}></wu-avatar>`},i={render:()=>u`
  ...
  \`
}`,...(o=(l=i.parameters)==null?void 0:l.docs)==null?void 0:o.source}}};const p=["WithInitials","AllSizes"];export{i as AllSizes,a as WithInitials,p as __namedExportsOrder,v as default};
