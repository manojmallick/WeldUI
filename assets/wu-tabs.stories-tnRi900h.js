import{b as i}from"./lit-element-CBn2YVps.js";const u={title:"Components/Tabs",component:"wu-tabs",tags:["autodocs"],argTypes:{orientation:{control:"radio",options:["horizontal","vertical"]}},parameters:{docs:{description:{component:"Tab navigation with associated panels. Three composable elements: `<wu-tabs>` (container), `<wu-tab>` (trigger) and `<wu-tab-panel>` (content). Full keyboard navigation included."}}}},t={render:()=>i`
