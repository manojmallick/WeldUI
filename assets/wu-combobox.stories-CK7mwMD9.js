import{b as s}from"./lit-element-CWHijwDH.js";const S={title:"Components/Combobox",component:"wu-combobox",tags:["autodocs"]},l=[{value:"ts",label:"TypeScript"},{value:"js",label:"JavaScript"},{value:"py",label:"Python"},{value:"rs",label:"Rust"},{value:"go",label:"Go"}],o={render:()=>s`
