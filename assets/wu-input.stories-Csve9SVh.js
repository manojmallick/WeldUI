import{b as l}from"./lit-element-CWHijwDH.js";import"./index-SgSA6QNV.js";import"./property-CV4LBOm_.js";import"./state-kdcVxHgv.js";import"./query-BApjzB0v.js";import"./style-map-CRZOmCei.js";const z={title:"Components/Input",component:"wu-input",tags:["autodocs"],argTypes:{type:{control:"select",options:["text","email","password","number","search"]},size:{control:"radio",options:["sm","md","lg"]}}},e={args:{label:"Email",placeholder:"you@example.com",type:"email"},render:t=>l`<wu-input label=${t.label} placeholder=${t.placeholder} type=${t.type} style="max-width:320px"></wu-input>`},r={render:()=>l`<wu-input label="Username" value="ab" error="Must be at least 3 characters" style="max-width:320px"></wu-input>`},a={render:()=>l`
...
}`,...(o=(s=e.parameters)==null?void 0:s.docs)==null?void 0:o.source}}};var i,n,u;r.parameters={...r.parameters,docs:{...(i=r.parameters)==null?void 0:i.docs,source:{originalSource:'{\n  render: () => html`<wu-input label="Username" value="ab" error="Must be at least 3 characters" style="max-width:320px"></wu-input>`\n}',...(u=(n=r.parameters)==null?void 0:n.docs)==null?void 0:u.source}}};var m,d,c;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display:flex;flex-direction:column;gap:12px;max-width:320px">
      <wu-input size="sm" placeholder="Small"></wu-input>
      <wu-input size="md" placeholder="Medium"></wu-input>
  ...
  \`
}`,...(c=(d=a.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};const f=["Default","WithError","AllSizes"];export{a as AllSizes,e as Default,r as WithError,f as __namedExportsOrder,z as default};
