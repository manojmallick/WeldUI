import{b as o}from"./lit-element-CBn2YVps.js";const m={title:"Components/MultiSelect",component:"wu-multi-select",tags:["autodocs"]},c=[{value:"apple",label:"Apple"},{value:"banana",label:"Banana"},{value:"cherry",label:"Cherry"},{value:"date",label:"Date"},{value:"elderberry",label:"Elderberry"}],e={render:()=>o`
