import{b as a}from"./lit-element-CWHijwDH.js";import"./index-BM5e8oBU.js";const w={title:"Components/Toggle",component:"wu-toggle",tags:["autodocs"],argTypes:{checked:{control:"boolean"},disabled:{control:"boolean"},size:{control:"radio",options:["sm","md","lg"]}}},e={args:{label:"Enable notifications",checked:!1},render:t=>a`<wu-toggle label=${t.label} ?checked=${t.checked}></wu-toggle>`},l={render:()=>a`
