import{b as s}from"./lit-element-CWHijwDH.js";import"./index-SgSA6QNV.js";import"./property-CV4LBOm_.js";import"./state-kdcVxHgv.js";import"./query-BApjzB0v.js";import"./style-map-CRZOmCei.js";const $={title:"Components/Button",component:"wu-button",tags:["autodocs"],argTypes:{variant:{control:"select",options:["primary","secondary","ghost","danger","success"],description:"Visual style variant"},size:{control:"radio",options:["sm","md","lg"],description:"Size variant"},disabled:{control:"boolean",description:"Disables the button"},loading:{control:"boolean",description:"Shows loading spinner"},type:{control:"select",options:["button","submit","reset"],description:"Native button type"}},parameters:{docs:{description:{component:"A versatile button component supporting multiple variants, sizes, and states."}}}},n={args:{variant:"primary",size:"md",disabled:!1,loading:!1},render:t=>s`
  ...
  \`
}`,...(w=(c=e.parameters)==null?void 0:c.docs)==null?void 0:w.source}}};var m,g,v;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display:flex;gap:12px;flex-wrap:wrap;align-items:center">
      <wu-button>
        <span slot="prefix">⬅</span>
  ...
  \`
}`,...(v=(g=o.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};const D=["Default","AllVariants","Sizes","WithSlots"];export{a as AllVariants,n as Default,e as Sizes,o as WithSlots,D as __namedExportsOrder,$ as default};
