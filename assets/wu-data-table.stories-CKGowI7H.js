import{b as l}from"./lit-element-I0QAeI3K.js";import"./index-BlKKMvld.js";import"./directive-helpers-QMk0t2il.js";const o=[{key:"name",label:"Name",sortable:!0,width:"200px"},{key:"email",label:"Email",sortable:!0},{key:"role",label:"Role",sortable:!1,width:"120px"},{key:"status",label:"Status",sortable:!1,width:"100px"}],t=Array.from({length:10},(e,a)=>({name:`User ${a+1}`,email:`user${a+1}@example.com`,role:a%3===0?"Admin":a%3===1?"Editor":"Viewer",status:a%4===0?"Inactive":"Active"})),M={title:"Components/DataTable",component:"wu-data-table",tags:["autodocs"],argTypes:{loading:{control:"boolean"},selectable:{control:"boolean"},searchable:{control:"boolean"},page:{control:"number"},pageSize:{control:"number"},total:{control:"number"}}},n={args:{loading:!1,selectable:!1,searchable:!1,page:1,pageSize:10,total:10},render:e=>l`
    <wu-data-table
      .columns=${o}
      .rows=${t}
      total=${e.total}
  ...
  render: () => html\`
    ...
    ></wu-data-table>
  \`
}`,...(W=(L=u.parameters)==null?void 0:L.docs)==null?void 0:W.source}}};const x=["Default","Selectable","Searchable","Loading","Empty","WithPagination"];export{n as Default,d as Empty,c as Loading,r as Searchable,s as Selectable,u as WithPagination,x as __namedExportsOrder,M as default};
