import{b as r}from"./lit-element-I0QAeI3K.js";const k={title:"Layout/SplitPane",component:"wu-split-pane",tags:["autodocs"],argTypes:{orientation:{control:"radio",options:["horizontal","vertical"]},initialSize:{control:"number"},minSize:{control:"number"},maxSize:{control:"number"},collapsible:{control:"boolean"},snapThreshold:{control:"number"},keyStep:{control:"number"}}},o="padding:16px; height:100%; box-sizing:border-box; font-family:var(--wu-font-sans); font-size:var(--wu-text-sm)",e={render:()=>r`
