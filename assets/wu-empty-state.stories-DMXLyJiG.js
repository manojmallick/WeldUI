import{b as s}from"./lit-element-CWHijwDH.js";import"./index-SgSA6QNV.js";import"./property-CV4LBOm_.js";import"./state-kdcVxHgv.js";import"./query-BApjzB0v.js";import"./style-map-CRZOmCei.js";const k={title:"Components/EmptyState",component:"wu-empty-state",tags:["autodocs"],argTypes:{title:{control:"text"},description:{control:"text"}}},t={args:{title:"Nothing here yet",description:"Get started by creating your first item."},render:n=>s`
  ...
  \`
}`,...(u=(i=t.parameters)==null?void 0:i.docs)==null?void 0:u.source}}};var c,p,d;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => html\`
    <wu-empty-state
      title="No projects found"
      description="Create a new project to get started."
  ...
  \`
}`,...(d=(p=e.parameters)==null?void 0:p.docs)==null?void 0:d.source}}};var m,l,w;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="border:1px solid var(--wu-color-border); border-radius:var(--wu-radius-lg); padding:var(--wu-space-4)">
      <wu-empty-state
        title="No records"
  ...
  \`
}`,...(h=(g=o.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};const S=["Default","WithAction","NoData","CustomIcon"];export{o as CustomIcon,t as Default,r as NoData,e as WithAction,S as __namedExportsOrder,k as default};
