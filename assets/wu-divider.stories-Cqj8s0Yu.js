import{b as o}from"./lit-element-CBn2YVps.js";const v={title:"Components/Divider",component:"wu-divider",tags:["autodocs"],argTypes:{vertical:{control:"boolean"}},parameters:{docs:{description:{component:"A thin separator between sections. Supports horizontal (default) and vertical orientation. Accepts an optional label via the default slot."}}}},e={render:()=>o`
