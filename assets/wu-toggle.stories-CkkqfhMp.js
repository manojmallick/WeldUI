import{b as a}from"./lit-element-CTfEKIed.js";import"./index-B0i-QSD2.js";const w={title:"Components/Toggle",component:"wu-toggle",tags:["autodocs"],argTypes:{checked:{control:"boolean"},disabled:{control:"boolean"},size:{control:"radio",options:["sm","md","lg"]}}},e={args:{label:"Enable notifications",checked:!1},render:t=>a`<wu-toggle label=${t.label} ?checked=${t.checked}></wu-toggle>`},l={render:()=>a`
