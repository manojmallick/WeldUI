import{b as n}from"./lit-element-CBn2YVps.js";const c={title:"Navigation/SpeedDial",component:"wu-speed-dial",tags:["autodocs"]},l=[{label:"New Document",value:"doc",icon:"📄"},{label:"Upload File",value:"upload",icon:"📤"},{label:"New Folder",value:"folder",icon:"📁"}],e={render:()=>n`
