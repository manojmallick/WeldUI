import{b as e}from"./lit-element-I0QAeI3K.js";import"./index-BlKKMvld.js";import"./directive-helpers-QMk0t2il.js";const k={title:"Components/ErrorPage",component:"wu-error-page",tags:["autodocs"],argTypes:{code:{control:"text"},title:{control:"text"},description:{control:"text"}}},o={args:{code:"404"},render:r=>e`
  ...
  \`
}`,...(f=(x=s.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};const E=["NotFound","ServerError","ServiceUnavailable","AccessDenied","CustomError"];export{a as AccessDenied,s as CustomError,o as NotFound,t as ServerError,n as ServiceUnavailable,E as __namedExportsOrder,k as default};
