import{b as e}from"./lit-element-I0QAeI3K.js";const W={title:"Navigation/Dropdown",component:"wu-dropdown",tags:["autodocs"]},D=[{label:"New File",value:"new",icon:"📄",group:"File"},{label:"Open…",value:"open",icon:"📂",group:"File"},{label:"Save",value:"save",icon:"💾",group:"File"},{separator:!0,label:"",value:""},{label:"Cut",value:"cut",icon:"✂️",group:"Edit"},{label:"Copy",value:"copy",icon:"📋",group:"Edit"},{label:"Paste",value:"paste",icon:"📌",group:"Edit",disabled:!0},{separator:!0,label:"",value:""},{label:"Delete",value:"delete",danger:!0,icon:"🗑️"}],t={render:()=>e`
