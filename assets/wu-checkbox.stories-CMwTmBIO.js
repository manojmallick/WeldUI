import{b as s}from"./lit-element-CWHijwDH.js";import"./index-SgSA6QNV.js";import"./property-CV4LBOm_.js";import"./state-kdcVxHgv.js";import"./query-BApjzB0v.js";import"./style-map-CRZOmCei.js";const x={title:"Components/Checkbox",component:"wu-checkbox",tags:["autodocs"],argTypes:{checked:{control:"boolean"},indeterminate:{control:"boolean"},disabled:{control:"boolean"}}},e={args:{label:"Accept terms",checked:!1},render:o=>s`<wu-checkbox label=${o.label} ?checked=${o.checked}></wu-checkbox>`},c={render:()=>s`
  ...
  \`
}`,...(d=(n=c.parameters)==null?void 0:n.docs)==null?void 0:d.source}}};const p=["Default","AllStates"];export{c as AllStates,e as Default,p as __namedExportsOrder,x as default};
