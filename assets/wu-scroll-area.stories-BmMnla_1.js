import{b as o}from"./lit-element-CBn2YVps.js";const m={title:"Layout/ScrollArea",component:"wu-scroll-area",tags:["autodocs"]},p=Array.from({length:20},(d,c)=>o`<p>Line ${c+1} — Lorem ipsum dolor sit amet consectetur adipiscing elit.</p>`),r={render:()=>o`<wu-scroll-area max-height="200px" orientation="vertical">${p}</wu-scroll-area>`},e={render:()=>o`
