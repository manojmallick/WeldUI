import{b as m}from"./lit-element-I0QAeI3K.js";import"./index-BlKKMvld.js";import"./directive-helpers-QMk0t2il.js";const $={title:"Enterprise/Event Calendar",component:"wu-event-calendar",tags:["autodocs"]},p=new Date,e=p.getFullYear(),t=String(p.getMonth()+1).padStart(2,"0"),u=[{id:"1",title:"Team standup",date:`${e}-${t}-05`},{id:"2",title:"Product demo",date:`${e}-${t}-12`},{id:"3",title:"Sprint planning",date:`${e}-${t}-15`,color:"#7c3aed"},{id:"4",title:"All hands",date:`${e}-${t}-20`}],a={render:()=>m`
