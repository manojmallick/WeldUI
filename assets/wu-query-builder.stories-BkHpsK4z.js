import{b as u}from"./lit-element-I0QAeI3K.js";import"./index-BlKKMvld.js";import"./directive-helpers-QMk0t2il.js";const p={title:"Enterprise/Query Builder",component:"wu-query-builder",tags:["autodocs"]},n=[{id:"name",label:"Name",type:"string"},{id:"age",label:"Age",type:"number"},{id:"active",label:"Active",type:"boolean"},{id:"created",label:"Created At",type:"date"}],e={render:()=>u`<wu-query-builder .fields=${n} style="max-width:600px"></wu-query-builder>`},r={render:()=>u`
    <wu-query-builder
      .fields=${n}
