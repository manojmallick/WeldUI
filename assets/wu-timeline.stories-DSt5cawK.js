import{b as m}from"./lit-element-CWHijwDH.js";const l={title:"Components/Timeline",component:"wu-timeline",tags:["autodocs"]},e={render:()=>m`
  <wu-timeline>
  ...
  </wu-timeline>`};var t,i,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  render: () => html\`
  <wu-timeline>
    <wu-timeline-item title="Pull request merged" meta="2 hours ago" status="success">Merged feature/auth into main</wu-timeline-item>
    <wu-timeline-item title="Build running" meta="1 hour ago" status="pending">CI pipeline in progress…</wu-timeline-item>
...
}`,...(n=(i=e.parameters)==null?void 0:i.docs)==null?void 0:n.source}}};const r=["Default"];export{e as Default,r as __namedExportsOrder,l as default};
